...
class ConclavePipeline:
    ...
    def _summarize(self, query: str, context: Dict[str, Any], deliberation: Dict[str, Any], route: Dict[str, Any], quality: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary_prompt = (
            ...
            " Start with a single ## Verdict line that states the decision AND the primary reason."
            " Bad: '## Verdict: Do Not Submit'. Good: '## Verdict: Do Not Submit — router holds zero tokens and earn integration is not yet active'."
            " Bad: '## Verdict: Buy in 2028'. Good: '## Verdict: Buy Enumclaw in 2028 if liquid assets exceed $400K at close'."
            " The verdict line must be self-contained — a reader should understand the decision without reading further."
